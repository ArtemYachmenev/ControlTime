...
public class WindowShowingStatistics {
    ...
    void initialize() {
        ...
        RecentStatisticsButton.setOnAction(ActionEvent -> {
            openStat24("/sample/Вид/fxml/StaticsicsScene/TimeControl.ShowingStatistics24.fxml");
        } );

        StatisticsForTheSelectedTimeButton.setOnAction(ActionEvent -> {
            openStatSelectTime("/sample/Вид/fxml/StaticsicsScene/TimeControl.ShowingStatisticsSelectTime.fxml");
        });
